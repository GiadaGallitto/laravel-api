    ...
    <form action="{{ route($route, $project->slug) }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="my-3 text-center">
            <h4 for="author">Author: {{ $project->user->name }} </h4>
        </div>
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control @error('argument') is-invalid @enderror" id="argument"
                name="argument" value="{{ old('argument', $project->argument) }}">
            @error('argument')
                <div class="invalid-feedback">
                    {{ $message }}
                </div>
        ...
        <div class="mb-3">
            ...
            <select class="form-control @error('type_id') is-invalid @enderror" id="type_id" name="type_id">
                @foreach ($types as $type)
                    <option style="background-color: {{ $type->color }}" value="{{ $type->id }}"
        ...
        <div class="mb-3">
            ...
            @foreach ($technologies as $technology)
                <input type="checkbox" class="form-check-input" id="project_technologies" name="technologies[]"
                    value="{{ $technology->id }}"
        ...
        <div class="mb-3">
            ...
            <input type="file" name="image" id="image"
                class="form-control @error('image') is-invalid @enderror" value="{{ 'image', $project->image }}">
            @error('image')
                <div class="invalid-feedback">
                    {{ $message }}
                </div>
        ...
        <div class="mb-3">
            ...
            <input type="checkbox" class="form-check-input @error('concluded') is-invalid @enderror" id="concluded"
                name="concluded" value="1" {{ old('concluded', $project->concluded) ? 'checked' : '' }}>
        </div>

        <div class="buttons">
            <a href="{{ route('admin.projects.index') }}" class="btn btn-dark me-2"><i
